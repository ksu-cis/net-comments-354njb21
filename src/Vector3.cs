...
namespace VectorMath
{
    ...
    public class Vector3
    {
        ...
        /// <summary>
        /// Calculating the cross product of this and the other vector
        /// </summary>
        /// <param name="other">The Vector3 that is going to be crossed with this</param>
        /// <returns>The resulting vector from the cross product</returns>
